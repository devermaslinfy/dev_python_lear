    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('associates', models.ManyToManyField(to=settings.AUTH_USER_MODEL)),
                ('owner', models.ForeignKey(related_name='owned_account', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
                ('parent_account', models.ForeignKey(blank=True, to='learlight.Account', null=True)),
            ],
            options={
                'abstract': False,
            },
